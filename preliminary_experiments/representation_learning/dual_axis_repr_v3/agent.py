"""Dual-axis hybrid (v3) representation encoder for Leduc Hold'em states.
...
class DualAxisV3Agent(BaseAgent):
    """Agent that produces dual-axis hybrid state embeddings.
