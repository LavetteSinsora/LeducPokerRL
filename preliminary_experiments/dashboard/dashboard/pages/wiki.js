...
function initSidebar() {
    ...
    const groups = [
        {
            label: 'Baselines',
            description: 'Promoted reference agents',
            ids: ['heuristic', 'cfr']
        },
        {
            label: 'Value Lineage',
            description: 'Promoted learned value agents',
            ids: ['value_based', 'adaptive_value', 'modulated_value']
        }
    ];
    ...
    groups.forEach(group => {
        ...
        if (agentsDiv.children.length > 0) {
