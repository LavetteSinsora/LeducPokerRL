"""
value_opponent_pool — Final Evaluation Script
===============================================
...
def main():
    ...
    print(f"\n{'='*65}")
    print(f"  value_opponent_pool — Final Evaluation")
    ...
    print(f"{'─'*50}")
    scores = [v["avg_chips_per_round"] for v in results.values()]
    print(f"  {'Overall avg':<20}  {sum(scores)/len(scores):>+16.4f}")
    print(f"  {'Worst case':<20}  {min(scores):>+16.4f}")
