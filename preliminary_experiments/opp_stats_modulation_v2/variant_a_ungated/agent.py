...
value residual via TD(0) training under the new weighted training recipe.

Key difference from opp_stats_modulation_v1/variant_a_td:
  - Near-zero output-layer init (was default init in v1). Ensures training
    starts close to the frozen base, reducing initial disruption.
  - Same architecture otherwise — this variant isolates the training-recipe effect.
"""
...
class UngatedModAgent(BaseAgent):
    """
