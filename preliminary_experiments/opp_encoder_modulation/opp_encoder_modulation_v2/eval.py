"""Evaluate opponent-encoder modulation v1 against promoted agents."""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate opponent-encoder modulation v1.")
    parser.add_argument(
        "--checkpoint",
        type=Path,
    ...
    payload = {
        ...
        "baseline_v1": {
            "scores": v1_scores,
            "metrics": compute_robustness_metrics(v1_scores),
            "details": v1_details,
        },
    }
