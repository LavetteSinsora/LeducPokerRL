"""Train the opponent-encoder modulation experiment."""
...
def main():
    parser = argparse.ArgumentParser(description="Train opponent-encoder modulation v1.")
    ...
    parser.add_argument(
        "--smoke",
        action="store_true",
        help="Use a tiny budget for a quick pipeline check.",
    )
