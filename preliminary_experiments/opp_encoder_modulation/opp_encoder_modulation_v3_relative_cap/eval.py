"""Evaluate the relative-cap follow-up against promoted agents."""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate opponent-encoder modulation v3 relative cap.")
    parser.add_argument(
        "--checkpoint",
        type=Path,
