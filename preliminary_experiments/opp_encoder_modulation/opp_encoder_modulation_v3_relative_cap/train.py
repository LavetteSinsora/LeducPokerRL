"""Train the opponent-encoder modulation relative-cap experiment."""
...
from experiments.opp_encoder_modulation_v3_relative_cap.trainer import OpponentEncoderModulationTrainer
...
def main():
    parser = argparse.ArgumentParser(description="Train opponent-encoder modulation v3 relative cap.")
    ...
    parser.add_argument("--action-loss-weight", type=float, default=0.5, help="Auxiliary loss weight.")
    ...
    parser.add_argument(
        "--relative-effective-cap",
        type=float,
        default=0.1,
        help="Hard cap multiplier on |base value| for the effective residual.",
    )
    parser.add_argument(
        "--cap-bias",
        type=float,
        default=0.5,
        help="Bias term added inside the effective residual cap.",
    )
    ...
    config = {
        ...
        "relative_effective_cap": args.relative_effective_cap,
        "cap_bias": args.cap_bias,
