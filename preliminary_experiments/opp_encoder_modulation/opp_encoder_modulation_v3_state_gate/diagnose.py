"""Architecture-specific diagnostics for the state-gated follow-up."""
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose opponent-encoder modulation v3 state gate.")
    parser.add_argument(
        "--checkpoint",
        type=Path,
