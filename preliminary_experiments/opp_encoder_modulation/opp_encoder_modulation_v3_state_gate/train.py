"""Train the opponent-encoder modulation state-gate experiment."""
...
from experiments.opp_encoder_modulation_v3_state_gate.trainer import OpponentEncoderModulationTrainer
...
def main():
    parser = argparse.ArgumentParser(description="Train opponent-encoder modulation v3 state gate.")
