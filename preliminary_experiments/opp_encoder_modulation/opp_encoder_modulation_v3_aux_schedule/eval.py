"""Evaluate the auxiliary-schedule follow-up against promoted agents."""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate opponent-encoder modulation v3 auxiliary schedule.")
    parser.add_argument(
        "--checkpoint",
        type=Path,
