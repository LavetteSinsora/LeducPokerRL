"""Architecture-specific diagnostics for the auxiliary-schedule follow-up."""
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose opponent-encoder modulation v3 auxiliary schedule.")
    parser.add_argument(
        "--checkpoint",
        type=Path,
