...
class TrainingManager:
    def __init__(self, agent_id: str = "value_based"):
        self.agent_id = agent_id

        self.model_path = registry.get_checkpoint_path(agent_id)
        self.history_path = registry.get_history_path(agent_id)
            ...
            if self.matchup_opponents:
                ...
                for opp_id in self.matchup_opponents:
                    try:
                        ...
                        model_path = registry.get_checkpoint_path(opp_id)
