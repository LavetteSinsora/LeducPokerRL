"""
Adaptive-History Trainer — session-based training for the combo agent.
...
This trainer adds:
  - action_history carry-forward (same as HistoryValueTrainer)
...
class AdaptiveHistoryTrainer(AdaptiveTrainer):
    """
    Session-based trainer for AdaptiveHistoryAgent.

    Combines AdaptiveTrainer's session-based stats accumulation with
    HistoryValueTrainer's action history carry-forward in collect_episode().
    """
